      ...
      <div class="col-md-12">
        <div class="tw-mb-2 tw-flex tw-flex-wrap tw-items-center tw-justify-between tw-gap-2">
          ...
          <div class="tw-flex tw-flex-wrap tw-gap-2">
            ...
            <select id="f-priority" class="form-control input-sm" style="width:110px">
            ...
            <a href="<?php echo admin_url('hr_module/helpdesk/submit'); ?>" class="btn btn-primary btn-sm">
              <i class="fa fa-plus tw-mr-1"></i><?php echo _l('hr_helpdesk_add'); ?>
            </a>
            <?php endif; ?>
          </div>
        </div>
        <div class="panel_s">
          <div class="panel-body panel-table-full">
            <?php render_datatable([
              ...
              _l('hr_status'), 'Submitted', _l('hr_actions'),
            ], 'hr-helpdesk'); ?>
          </div>
        </div>
      </div>
