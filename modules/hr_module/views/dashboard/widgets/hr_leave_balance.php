        ...
        <div class="panel-body padding-10">
            ...
            <div class="tw-flex tw-justify-between tw-items-center tw-p-1.5">
                <p class="tw-font-semibold tw-flex tw-items-center tw-mb-0 tw-space-x-1.5 rtl:tw-space-x-reverse">
                    <i class="fa fa-plane tw-text-neutral-500 tw-mr-1"></i>
                    <span class="tw-text-neutral-700">HR Leave Balance</span>
                </p>
                <a href="<?php echo admin_url('hr_module/leave'); ?>">
            ...
            <div class="tw-text-center tw-py-2">
                <div class="tw-text-2xl tw-font-bold text-success"><?php echo hr_format_total_minutes_duration($hr_stats['leave_balance_remaining_minutes'] ?? 0, $hr_stats['leave_hours_per_day'] ?? 8); ?></div>
                <div class="tw-text-xs tw-text-neutral-500 tw-mt-1">Casual Leave days remaining</div>
                <div class="tw-text-xs tw-text-neutral-400 tw-mt-1"><?php echo hr_format_total_minutes_duration($hr_stats['leave_days_used_minutes'] ?? 0, $hr_stats['leave_hours_per_day'] ?? 8); ?> used this year</div>
            </div>
        </div>
    </div>
    <?php else: ?>
