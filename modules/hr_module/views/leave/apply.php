...
(function(){
    ...
    function dayRowHtml(i) {
        return ''
            ...
            +               '<input type="time" name="days[' + i + '][hour_start]" class="form-control input-sm day-hour-start" step="60">'
            +             '</div>'
            +             '<div class="col-xs-6">'
            +               '<label class="tw-text-xs"><?php echo _l('hr_leave_hour_end'); ?></label>'
            +               '<input type="time" name="days[' + i + '][hour_end]" class="form-control input-sm day-hour-end" step="60">'
            +             '</div>'
            +           '</div>'
            +         '</div>'
            +       '</div>'
