...
class Settings extends AdminController
{
    ...
    private function _save_settings()
    {
        ...
        $numeric_ranges = [
            ...
            'night_shift_grace_hours'        => [0, 24,   'Night shift grace period must be between 0 and 24 hours.'],
            'hr_income_tax_rate'             => [0, 100,  'Income tax rate must be between 0 and 100.'],
            'default_overtime_rate'          => [1, 5,    'Overduty rate must be between 1 and 5.'],
            'overtime_holiday_rate'          => [1, 5,    'Holiday overduty rate must be between 1 and 5.'],
            'overtime_day_divisor'           => [1, 31,   'Overduty day divisor must be between 1 and 31.'],
